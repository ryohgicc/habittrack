      ...
      <div className="space-y-4 text-sm">
        <section>
          ...
          <p className="text-gray-600 leading-relaxed text-xs mb-2">
            插件悬浮窗会自动显示在网页右下角。请按以下步骤操作：
          </p>
          <ol className="list-decimal list-inside space-y-2 text-gray-600">
            <li>
              <span className="font-medium text-gray-800">创建任务</span>：在任意象限的输入框中输入任务名称，按 <span className="bg-gray-100 px-1 rounded border">Enter</span> 键添加。
            </li>
            <li>
              <span className="font-medium text-gray-800">开始专注</span>：直接点击任务条目，计时器立即启动。再次点击或点击底部“休息”可暂停。
            </li>
            <li>
              <span className="font-medium text-gray-800">结束任务</span>：悬停在任务上，点击 <span className="inline-flex items-center justify-center w-4 h-4 bg-green-50 rounded text-green-600 border border-green-200 text-[10px]">✓</span> 完成任务；或点击底部“结束”按钮停止当前专注。
            </li>
          </ol>
        </section>
